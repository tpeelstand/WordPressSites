    ...
    <div class="extendthemes-demo-import-popup-container pro-only">
        ...
        <div class="popup-footer">
            <div class="footer-content">
                ...
                <a href='http://extendthemes.com/go/mesmerize-upgrade' class='button button-hero button-primary upgrade-to-pro' target='_blank'><?php esc_html_e('Check all PRO features', 'mesmerize-companion'); ?></a>
            </div>
        </div>
    </div>
</script>
